...
- **Idioma dos comentários**: `padroes-codigo.md` manda pt-BR, mas ~95% do código está em inglês. **Decisão (Etapa 19)**: mantida a regra pt-BR (consistente com `docs/`); apenas os comentários sobreviventes da triagem da Etapa 23 são traduzidos — nada de tradução em massa antes da decomposição

...
| `macos/Runner/Assets.xcassets/AppIcon.appiconset/` | PNGs 16–1024 px gerados pelo `flutter_launcher_icons` a partir de `assets/icon/decima_icon_fullbleed.png`; o Xcode compila o `.icns` no bundle |
